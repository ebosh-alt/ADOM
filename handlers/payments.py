...
from config import bot, pay_token, success_payment, payment_title, payment_description
from db import users, Prices, TypeSubscribes, CountMessageSubscribes, CountDaySubscribes
